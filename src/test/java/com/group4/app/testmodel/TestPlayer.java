...
public class TestPlayer {
    ...
    public void testConstructors() {
        ...
        world.addTile(t1);
        Player player = new Player("player", 10, 3, null, world.getId(), new Position(0, 0));
        ...
        world.addTile(t1);
        player = new Player("player", 10, 3, weapon, world.getId(), new Position(0, 0));
    ...
    public void testMove() {
        ...
        world.addTile(t2);
        Player p = new Player("player", 10, 3, null, world.getId(), new Position(0, 0));
    ...
    public void testIllegalMove() {
        ...
        Player p = new Player("player", 10, 5, null, world.getId(), new Position(0, 0));
    ...
    public void setWeapon() {
        ...
        Tile t1 = new Tile("stone", world.getId(), 0, 0);
        world.addTile(t1);
        Player p = new Player("player", 10, 3, WeaponFactory.createSword(), world.getId(), new Position(0, 0));
